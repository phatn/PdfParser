 ...
 * Java runtime.
 * </p>
 * @see <a href="https://issues.apache.org/jira/browse/PDFBOX-521">PDFBOX-521</a>
 * @author phat@manifera.com
 *
 */
...
public class PDFTextStripperEx extends PDFTextStripper {
    ...
    private String paragraphEnd = getLineSeparator();
    private String pageStart = getLineSeparator();
    private String pageEnd = getLineSeparator();
    private String articleStart = getLineSeparator();
    private String articleEnd = getLineSeparator();
	...
	protected PositionWrapper handleLineSeparation(PositionWrapper current,
		...
		if (current.isParagraphStart()) {
			...
			// Comment it out to make one line paragraph
			//writeLineSeparator();
		}
     ...
     * @return
     */
/*    protected static Pattern matchPattern(String s, List<Pattern> patterns){
